...
public class MazeSearch {
    ...
    private void explore(Cell cell) {
        ...
        for (Cell to : neighbours.get(cell)) {
            if(!to.isVisited()){
                drawPassage(cell, to, Color.yellow, true);
                explore(to);
                if(finished) break;
                drawPassage(cell, to, Color.RED, true);
            }
        ...
        //    drawPassage(cell, neighbour, Color.yellow, true);
        //}

        //drawPassage(cell, 
        //mark cell visted
        //if found exit set finished to true
        //new cell yellow
        //visted cell red
        //recursively call left right ahead each cell
